...
//Desenho da barra
// Caminho das imagens da barra
  $path_imgs = DIRECTORY_SEPARATOR . "res" . DIRECTORY_SEPARATOR . "boletophp" . DIRECTORY_SEPARATOR . "imagens" . DIRECTORY_SEPARATOR;


//Guarda inicial
?><img src=<?php echo $path_imgs; ?>/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo $path_imgs; ?>b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo $path_imgs; ?>p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo $path_imgs; ?>b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=<?php echo $path_imgs; ?>p.png width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=<?php echo $path_imgs; ?>b.png width=<?php echo $f2?> height=<?php echo $altura?> border=0><img 
<?php
  }
}
...
// Draw guarda final
?>
src=<?php echo $path_imgs; ?>p.png width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src=<?php echo $path_imgs; ?>b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?php echo $path_imgs; ?>p.png width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da função
